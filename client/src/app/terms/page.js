...
function TermsPage() {
  ...
  const serviceDescriptionPoints = ["A searchable database of radiator repair shops and service providers","Business contact information, locations, hours, services, photos, and third-party review summaries","Owner-uploaded shop photo galleries on claimed listings, with higher photo limits for optional Featured upgrades","Search and filtering capabilities","Educational blog and FAQ content about radiator repair and using the directory","General contact forms for directory questions, listing help, and feedback","Quick Contact, a tool to submit service inquiries to claimed business listings","Business claiming, so eligible owners can verify listing email access and create an account to manage their listing through a dashboard and account settings, including listing analytics and shop photos","Optional paid Featured listing upgrades for claimed businesses, billed through Stripe","Report Info, a tool to report incorrect claim contact details, incorrect or outdated listing info, or inappropriate listing content","An optional short site feedback survey that may appear after you submit certain forms","A Tools & Supplies Shop and related product recommendations, including Amazon Associate affiliate links",
  ];
