    ...
    <div className="bg-slate-900 border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-white mb-2 font-heading">
          Radiator Repair Services in {stateName}
        </h1>
        <p className="text-lg text-gray-300 font-body">
          Find trusted radiator repair specialists in {stateName}. Compare
          services, read reviews, and get your vehicle running smoothly.
        </p>
      </div>
    </div>
  );
