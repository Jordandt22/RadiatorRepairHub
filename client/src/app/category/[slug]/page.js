...
export async function generateMetadata({ params }) {
  ...
  return {
    title,
    description,
    keywords: `${primaryCategory.name}, ${primaryCategory.name.toLowerCase()} services, auto repair, automotive services, radiator repair, cooling system repair, car maintenance`,
    openGraph: {
      title,
      description,
      type: "website",
