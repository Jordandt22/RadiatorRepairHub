export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    relatedBlogs: [
      ...
      },
      {
        ...
        href: "/blogs/can-a-bad-radiator-damage-your-engine",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    question: "What's the difference between radiator repair and replacement?",
    answer:
  ...
  },
  {
    ...
    relatedBlogs: [
      ...
      },
      {
        ...
        href: "/blogs/how-long-does-a-radiator-last",
      },
    ],
  },
  {
...
const faqById = new Map(FAQ_ITEMS.map((item) => [item.id, item]));

function pickFaqs(ids) {
  return ids.map((id) => faqById.get(id)).filter(Boolean);
}

export const FAQ_SECTIONS = [
  {
    id: "finding-a-shop",
    title: "Finding & Choosing a Shop",
    description: "Search the directory and pick a shop you can trust.",
    faqIds: ["find-shop", "choose-shop"],
  },
  {
    id: "repair-cost-timing",
    title: "Repair, Cost & Timing",
    description: "Typical prices, turnaround time, and repair vs replacement.",
    faqIds: ["repair-cost", "repair-duration", "repair-vs-replace"],
  },
  {
    id: "symptoms-safety",
    title: "Symptoms & Safety",
    description: "Warning signs and when it is safe to drive.",
    faqIds: ["repair-signs", "drive-with-problem"],
  },
  {
    id: "maintenance-prevention",
    title: "Maintenance & Prevention",
    description: "Coolant, servicing, and avoiding cooling system problems.",
    faqIds: [
      "service-interval",
      "coolant-types",
      "prevent-problems",
...
export function getFaqSectionsWithItems() {
  return FAQ_SECTIONS.map((section) => ({
    ...section,
    faqs: pickFaqs(section.faqIds),
  }));
}
...
export function getRelatedBlogs(faq) {
  if (Array.isArray(faq?.relatedBlogs) && faq.relatedBlogs.length > 0) {
    return faq.relatedBlogs;
  }
  if (faq?.relatedBlog) {
    return [faq.relatedBlog];
  }
  return [];
}
