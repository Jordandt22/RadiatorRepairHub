  ...
  return (
    <div className="space-y-3 md:space-y-4">
      {phone ? (
        ...
        <div className="flex items-center gap-2 md:gap-3">
          <Phone className="w-4 h-4 md:w-5 md:h-5 text-muted-foreground flex-shrink-0" />
          <span className="text-sm text-muted-foreground">No Phone Number Available</span>
        </div>
      )}
      ...
      {email ? (
        ...
        <div className="flex items-center gap-2 md:gap-3">
          <Mail className="w-4 h-4 md:w-5 md:h-5 text-muted-foreground flex-shrink-0" />
          <span className="text-sm text-muted-foreground">No Email Available</span>
        </div>
      )}
      ...
      {website ? (
        ...
        <div className="flex items-center gap-2 md:gap-3">
          <Globe className="w-4 h-4 md:w-5 md:h-5 text-muted-foreground flex-shrink-0" />
          <span className="text-sm text-muted-foreground">No Website Available</span>
        </div>
      )}
    </div>
  );
