...
const EMPTY_BY_TAB = {
  pending: {
    ...
    description: "New Contact page messages will appear here.",
  },
  resolved: {
    icon: CheckIcon,
    title: "No resolved inquiries",
    description: "Inquiries you mark as resolved will appear here.",
  },
  dismissed: {
    icon: XCircleIcon,
    title: "No dismissed inquiries",
    description: "Inquiries you dismiss will appear here.",
  },
};

export default function InquiriesEmptyState({ activeTab = "pending" }) {
