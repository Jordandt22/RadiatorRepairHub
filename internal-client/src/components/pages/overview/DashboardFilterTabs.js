...
export const VALID_DASHBOARD_TABS = ["inbox", "analytics", "systems"];

const TAB_OPTIONS = [
  { value: "inbox", label: "Inbox", Icon: InboxIcon },
  { value: "analytics", label: "Analytics", Icon: ActivityIcon },
  { value: "systems", label: "Systems", Icon: ServerIcon },
];

export default function DashboardFilterTabs({ value, onValueChange }) {
