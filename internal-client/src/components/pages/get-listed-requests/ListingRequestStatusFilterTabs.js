...
const TAB_OPTIONS = [
  ...
  { value: "listed", label: "Listed", Icon: CheckIcon },
  { value: "rejected", label: "Rejected", Icon: XCircleIcon },
  { value: "duplicate", label: "Duplicate", Icon: CopyIcon },
];

export default function ListingRequestStatusFilterTabs({
  value,
  onValueChange,
}) {
  const triggerClassName =
    "cursor-pointer hover:translate-y-[-2px] transition-all duration-200 px-6 rounded-full";
  const activeTab =
