...
const TAB_OPTIONS = [
  { value: "states", label: "States", Icon: MapPinnedIcon },
  { value: "cities", label: "Cities", Icon: Building2Icon },
  { value: "postal-codes", label: "Postal Codes", Icon: HashIcon },
  { value: "data-issues", label: "Data Issues", Icon: AlertTriangleIcon },
];

export default function LocationFilterTabs({ value, onValueChange }) {
