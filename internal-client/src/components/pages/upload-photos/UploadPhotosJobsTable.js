...
import UploadPhotosEmptyState from "@/components/pages/upload-photos/UploadPhotosEmptyState";
import IngestCountBadge from "@/components/pages/add-businesses/IngestCountBadge";

function UploadPhotosJobsTableView({
  jobs,
  selectedIds,
  onToggleId,
  onToggleAll,
            ...
            return (
              ...
              >
                ...
                <TableCell className="whitespace-nowrap">
                  <UploadPhotosStatusBadge status={row.status} />
                </TableCell>
...
function UploadPhotosJobsCardList({
  jobs,
  selectedIds,
  onToggleId,
  onToggleAll,
...
export default function UploadPhotosJobsTable({
  jobs = [],
  selectedIds,
  onToggleId,
  onToggleAll,
  ...
  if (!jobs.length) {
    return <UploadPhotosEmptyState />;
  }

  return (
    <>
      <UploadPhotosJobsCardList
        jobs={jobs}
