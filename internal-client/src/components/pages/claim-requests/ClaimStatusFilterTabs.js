...
const TAB_OPTIONS = [
  ...
  { value: "success", label: "Success", Icon: CheckIcon },
  { value: "failed", label: "Failed", Icon: XCircleIcon },
  { value: "expired", label: "Expired", Icon: TimerOffIcon },
];

export default function ClaimStatusFilterTabs({ value, onValueChange }) {
