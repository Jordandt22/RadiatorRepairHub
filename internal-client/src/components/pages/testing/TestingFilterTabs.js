import { Building2Icon, ChevronDownIcon, UsersIcon } from "lucide-react";
...
export const VALID_TABS = ["businesses", "users"];

const TAB_OPTIONS = [
  { value: "businesses", label: "Businesses", Icon: Building2Icon },
  { value: "users", label: "Users", Icon: UsersIcon },
];

export default function TestingFilterTabs({ value, onValueChange }) {
