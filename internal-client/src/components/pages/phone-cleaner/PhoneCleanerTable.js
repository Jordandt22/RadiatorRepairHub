...
import PhoneCleanerEmptyState from "@/components/pages/phone-cleaner/PhoneCleanerEmptyState";
...
function PhoneCleanerTableView({
  businesses,
  selectedIds,
  onToggleId,
  onToggleAll,
  ...
  const phoneWidth = showEdit ? "w-[22%]" : "w-[28%]";
      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead className={phoneWidth}>Phone</TableHead>
          ...
          {businesses.map((row) => {
            ...
            return (
              ...
              >
                ...
                <TableCell className={`max-w-0 ${phoneWidth}`}>
                  <span
                ...
                <TableCell className="whitespace-nowrap">
                  <PhoneCleanerStatusBadge status={row.phone_status} />
                </TableCell>
                <TableCell className="whitespace-nowrap">
                  <MarkedAtCell markedAt={row.phone_status_marked_at} />
                </TableCell>
...
export default function PhoneCleanerTable({
  businesses = [],
  selectedIds,
  onToggleId,
  onToggleAll,
