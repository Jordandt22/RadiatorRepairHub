...
export default function PhoneCleanerFiltersDialog({
  open,
  onOpenChange,
  emailsSent = null,
  suspicious = null,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Narrow phones by outreach sent status, suspicion, and review
            status.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="grid gap-4 py-1">
          <div className="grid gap-2">
            ...
            <BusinessTierCombobox
              ...
              inputName="rrh-phone-cleaner-sent-filter"
            />
          </div>
          <div className="grid gap-2">
            ...
            <BusinessTierCombobox
              ...
              ariaLabel="Filter by suspicious phones"
              inputName="rrh-phone-cleaner-suspicious-filter"
            />
          </div>
          <div className="grid gap-2">
            <Label>Status</Label>
            <BusinessTierCombobox
              ...
              inputName="rrh-phone-cleaner-status-filter"
            />
          </div>
        </div>
