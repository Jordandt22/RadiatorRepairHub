...
export const HAS_PHONE_FILTERS = [
  { id: "true", label: "Has phone" },
  { id: "false", label: "No phone" },
];
...
export default function PhoneCleanerReviewActions({
  searchValue = "",
  onSearchChange,
  filtersActive = false,
  onOpenFilters,
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <div className="relative min-w-0 flex-1 md:max-w-sm">
          ...
          <Input
            ...
            name="rrh-phone-cleaner-review-search"
            autoComplete="off"
