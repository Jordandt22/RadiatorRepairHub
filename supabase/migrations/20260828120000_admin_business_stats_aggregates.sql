CREATE INDEX IF NOT EXISTS idx_business_stats_stat_date
  ON public.business_stats USING btree (stat_date DESC);
...
BEGIN
  ...
  INTO v_impressions, v_listing_clicks, v_page_views, v_phone_clicks
  FROM public.business_stats s
