  ...
  return {
    data: {
      ...
      totals: {
        ...
        directions_clicks: Number(totals.directions_clicks || 0),
        website_clicks: Number(totals.website_clicks || 0),
        email_clicks: Number(totals.email_clicks || 0),
      },
      averages: {
        ...
        directions_clicks: Number(averages.directions_clicks || 0),
        website_clicks: Number(averages.website_clicks || 0),
